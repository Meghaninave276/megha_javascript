...
cart.className="bg-primary d-grid gap-2 border-0 px-5 py-2 rounded-pill text-white fw-bold"
...
productbox.appendChild(productive);
  ...
  const iandp=document.createElement("div");
  iandp.className="div d-flex";
  ...
  iandp.appendChild(image);
  cartdetail.appendChild(iandp);

  
  const h4=document.createElement("h5");
  h4.textContent=carts.title;
  h4.className="mt-1 ms-2 mt-3 fw-bold"
  iandp.appendChild(h4);
  cartdetail.appendChild(iandp);
...
prices.textContent="$"+(carts.price*carts.qty);
const quantity=document.createElement("h5");
quantity.textContent="qty:"+carts.qty;
quantity.className="mt-5 fw-bold me-4"



iandp.appendChild(quantity);
  ...
  p.appendChild(prices);
  cartdetail.appendChild(p);
  ...
  deletebtn.className="btn bg-warning px-5 mt-2 rounded-pill text-dark fw-bold";
